...
public class _11_Package {
    public static void main(String[] args) {
        ...
        System.out.println("랜덤 정수 (범위) : "+random.nextInt(10)); // 0~10 미만 정수형 값 반환
        System.out.println("랜덤 실수 : "+random.nextDouble()); // 0.0~1.0 미만 실수값
        //System.out.println("랜덤 실수 (범위) : "+ random.nextDouble()); 범위 설정이 안됨
        ...
        // nextInt(45) : 0~45미만 수
        // nextInt(45)+1 : 1이상 46미만 수 = 1~45이하의 수
